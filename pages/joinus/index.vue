      ...
      <div class="inside-content">
        ...
        <div class="inside-right">
          <div class="title">
            ...
            <a-breadcrumb>
              <a-breadcrumb-item><nuxt-link to="/">首页</nuxt-link></a-breadcrumb-item>
              <a-breadcrumb-item><nuxt-link :to="`/joinus`">人力资源</nuxt-link></a-breadcrumb-item>
              <a-breadcrumb-item>
                <nuxt-link :to="`/${current}`">{{ nowName }}</nuxt-link>
              </a-breadcrumb-item>
            </a-breadcrumb>
          </div>
          <div class="content">
            <div class="page-name">{{ nowName }}</div>
            <p>暂无数据，敬请期待……</p>
          </div>
        </div>
      </div>
